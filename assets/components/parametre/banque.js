const Toast = Swal.mixin({
    ...
    $("#save").on("submit", async (e) => {
        ...
        try {
            ...
            const request = await axios.post('/parametre/banque/new', formData);
    ...
    $("#modifier").on("click", async function(){
        ...
        try {
            ...
            const request = await axios.get('/parametre/banque/details/'+id_banque);
            const response = request.data;
    ...
    $("#udpate").on("submit", async (e) => {
        ...
        try {
            icon.remove('fa-check-circle').addClass("fa-spinner fa-spin ");
            const request = await axios.post('/parametre/banque/update/'+id_banque, formData);
            const response = request.data;
            table.ajax.reload();
            id_banque = false
            icon.addClass('fa-check-circle').removeClass("fa-spinner fa-spin ");
