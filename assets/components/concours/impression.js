...
$(document).ready(function  () {
    ...
    $("#impression_canvas").on('click', function () {
        window.open("/concours/impression/canvas", '_blank');
    })
    $("#import_impression_save").on("submit", async function(e) {
        ...
        try {
          const request = await axios.post('/concours/impression/import', formData);
    ...
    $("#imprimer").on('click', function () {
        window.open("/concours/impression/imprimer", '_blank');
    })
})
