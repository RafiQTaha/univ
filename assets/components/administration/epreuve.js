...
$(document).ready(function () {
  ...
  $("body #formationNrml").on("change", async function () {
    ...
    if (id_formation != "") {
      ...
      tableEpreuveNormal
        .columns(0)
        .search($("body #etablissementNrml").val())
        .draw();
    }
    $("#semestreNrml").html("").select2();
    $("#moduleNrml").html("").select2();
  ...
  $("body #etablissementRatt").on("change", async function () {
    ...
    if (id_etab != "") {
      ...
      if ($("#dateEpreuveRatt").val() != "") {
        tableEpreuveRattrapage
          .columns(6)
          .search($("#dateEpreuveRatt").val())
          .draw();
      } else {
  ...
  $("body #formationRatt").on("change", async function () {
    ...
    if (id_formation != "") {
      ...
      tableEpreuveRattrapage
        .columns(0)
        .search($("body #etablissementRatt").val())
        .draw();
    }
    $("#semestreRatt").html("").select2();
    $("#moduleRatt").html("").select2();
  ...
  $("#affilier_etudiant").on("click", async function (e) {
    ...
    if (rattrapage === 0) {
      ...
      try {
        ...
        const request = await axios.post(
          "/administration/epreuve/affiliation_normale",
          formData
        );
        const response = request.data;
      ...
      try {
        ...
        formData.append("epreuves", JSON.stringify(idEpreuves));
        const request = await axios.post(
          "/administration/epreuve/affiliation_rattrapage_Automatique",
          formData
        );
        const response = request.data;
        icon.addClass("fa-link").removeClass("fa-spinner fa-spin ");
  ...
  $("#cloture_epreuve").on("click", async function (e) {
    ...
    try {
      const request = await axios.post(
        "/administration/epreuve/cloture",
        formData
      );
      const response = request.data;
  ...
  $("#decloturer_epreuve").on("click", async function (e) {
    ...
    try {
      const request = await axios.post(
        "/administration/epreuve/decloture",
        formData
      );
      const response = request.data;
  ...
  $("#save_list_etudiant").on("click", async function (e) {
    ...
    try {
      const request = await axios.post(
        "/administration/epreuve/affiliation_rattrapage",
        formData
      );
      const response = request.data;
      icon.addClass("fa-check-circle").removeClass("fa-spinner fa-spin");
  ...
  $("body").on("submit", "#add_epreuve", async (e) => {
    ...
    try {
      const request = await axios.post(
        "/administration/epreuve/add_epreuve",
        formData
      );
      const response = request.data;
  ...
  $("#epreuve_imprimer").on("click", async function (e) {
    ...
    try {
      const request = await axios.get(
        "/administration/epreuve/checkifanonymat/" + id_epreuve
      );
      const response = request.data;
  ...
  $("#modifier_epreuve").on("click", async function (e) {
    ...
    try {
      const request = await axios.get(
        "/administration/epreuve/edit/" + id_epreuve
      );
      const response = request.data;
  ...
  $("#edit_epreuve").on("submit", async function (e) {
    ...
    try {
      const request = await axios.post(
        "/administration/epreuve/update/" + id_epreuve,
        formData
      );
      const response = request.data;
      icon.addClass("fa-check").removeClass("fa-spinner fa-spin ");
  ...
  $("body").on("click", "#impression_clair", function (e) {
    e.preventDefault();
    window.open(
      "/administration/epreuve/impression/" + id_epreuve + "/0",
      "_blank"
    );
  });
  $("body").on("click", "#impression_anonymat", function (e) {
    e.preventDefault();
    window.open(
      "/administration/epreuve/impression/" + id_epreuve + "/1",
      "_blank"
    );
  });
  $("body").on("click", "#extraction_emargement", function (e) {
    ...
    window.open(
      "/administration/epreuve/extraction_emargement/" + id_epreuve,
      "_blank"
    );
  });
  $("#capitaliser_etudiant").on("click", async function (e) {
    ...
    try {
      const request = await axios.post(
        "/administration/epreuve/capitaliser",
        formData
      );
      const response = request.data;
      console.log(response);
  ...
  $("body").on("submit", "#Affiler_inscriptions_ids", async function (e) {
    ...
    if (res == 1) {
      ...
      try {
        const request = await axios.post(
          "/administration/epreuve/affiliation_ParInscriptions",
          formData
        );
        const response = request.data;
        icon.addClass("fa-check").removeClass("fa-spinner fa-spin");
