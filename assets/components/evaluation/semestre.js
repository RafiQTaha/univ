...
$(document).ready(function () {
  ...
  $(
    "#enregister, #valider, #devalider, #recalculer, #imprimer, #statut, #deliberation_individuelle"
  ).attr("disabled", true);
  const enableButtons = () => {
    $("#imprimer")
  ...
  $("#deliberation_individuelle").on("click", async function () {
    window.open(
      "/evaluation/semestre/impression_delib/" + id_inscription,
      "_blank"
    );
  });
  ...
  $("#get_list_etudiant").on("click", async function (e) {
    ...
    try {
      ...
      const request = await axios.post(
        "/evaluation/semestre/list/" + semestre_id,
        formData
      );
  ...
  $("#statut_avant_rachat").on("click", async function () {
    ...
    try {
      const request = await axios.post(
        "/evaluation/semestre/statut/avantrachat"
      );
      let response = request.data;
      $("#get_list_etudiant").trigger("click");
  ...
  $("#statut_apres_rachat").on("click", async function () {
    ...
    try {
      const request = await axios.post(
        "/evaluation/semestre/statut/apresrachat"
      );
      let response = request.data;
      $("#get_list_etudiant").trigger("click");
      icon.addClass("fa-sync").removeClass("fa-spinner fa-spin");
  ...
  $("#statut_categorie").on("click", async function () {
    ...
    try {
      const request = await axios.post(
        "/evaluation/semestre/statut/statutsemestrecategorie"
      );
      let response = request.data;
      $("#get_list_etudiant").trigger("click");
      icon.addClass("fa-sync").removeClass("fa-spinner fa-spin");
  ...
  $("body").on("click", "#extraction", async function (e) {
    ...
    window.open(
      "/evaluation/semestre/extraction_semestre/" + $("#etablissement").val(),
      "_blank"
    );
  });
});
