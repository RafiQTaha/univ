...
class PlEmptimeRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function findSeanceByCurrentYears($currentyear)
    {
        ...
        epe.code as code_enseignant,epe.nom,epe.prenom,gr.id 'grade_id',gr.code as code_grade,gr.abreviation 'Grade',assure.nom 'Nom Prof Assure',assure.prenom 'Prenom Prof Assure',ep.observation
        FROM pl_emptime ep
