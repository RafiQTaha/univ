...
class HHonensRepository extends ServiceEntityRepository
{
    ...
    public function findHonoraireByCurrentYears($currentyear)
    {
        ...
        ens.code 'Code Enseignant',ens.nom 'Nom',ens.prenom 'Prenom',gr.id 'Id Grade',gr.designation 'Grade' ,hon.id 'Id Honoraire' , hon.nbr_heur 'Duree',IFNULL(hon.montant, 0)  'Montant', IFNULL(hon.brut, 0) 'Brut',IFNULL(hon.iar, 0) 'IAR',ens.cin 'CIN', ens.rib 'RIB'
        FROM hhonens hon
