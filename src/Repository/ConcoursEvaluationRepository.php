...
// findListEtudiantPharmacie
    ...
    public function findListEtudiantPharmacie($current_year, $type,$type_list)
    {
        return $this->createQueryBuilder('c')
            ->innerJoin('c.etudiant','etu')
            ->andWhere('c.rangFPA is not null')
