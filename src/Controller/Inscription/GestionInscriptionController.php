...
class GestionInscriptionController extends AbstractController
{
    ...
    {   
        ...
        $sheet->setCellValue('J1', 'DATE NAISSANCE');
        $sheet->setCellValue('K1', 'CIN');
        $sheet->setCellValue('L1', 'VILLE');
        $sheet->setCellValue('M1', 'TEL CANDIDAT');
        $sheet->setCellValue('N1', 'MAIL CANDIDAT');
        $sheet->setCellValue('O1', 'ETABLISSEMENT');
        $sheet->setCellValue('P1', 'FORMATION');
        $sheet->setCellValue('Q1', "NIVEAU D'ETUDES");
        $sheet->setCellValue('R1', 'TYPE DE BAC');
        $sheet->setCellValue('S1', 'ANNEE BAC');
        $sheet->setCellValue('T1', 'MOYENNE GENERALE');
        $sheet->setCellValue('U1', 'MOYENNE NATIONALE');
        $sheet->setCellValue('V1', 'MOYENNE REGIONALE');
        $sheet->setCellValue('W1', 'D-INSCRIPTION');
        ...
        foreach ($inscriptions as $inscription) {
            ...
            $sheet->setCellValue('K'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getCin());
            $sheet->setCellValue('L'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getVille());
            ...
            $sheet->setCellValue('O'.$i, $inscription->getAnnee()->getFormation()->getEtablissement()->getDesignation());
            $sheet->setCellValue('P'.$i, $inscription->getAnnee()->getFormation()->getDesignation());
            $sheet->setCellValue('Q'.$i, $inscription->getPromotion()->getDesignation());
            $sheet->setCellValue('R'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getTypeBac() == Null ? "" : $inscription->getAdmission()->getPreinscription()->getEtudiant()->getTypeBac()->getDesignation());
            $sheet->setCellValue('S'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getAnneeBac());
            $sheet->setCellValue('T'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getMoyenneBac());
            $sheet->setCellValue('U'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getMoyenNational());
            $sheet->setCellValue('V'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getMoyenRegional());
            $sheet->setCellValue('W'.$i, $inscription->getCreated());
