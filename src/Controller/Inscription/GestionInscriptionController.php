...
class GestionInscriptionController extends AbstractController
{
    ...
    {   
        ...
        $sheet->setCellValue('H1', 'DATE NAISSANCE');
        $sheet->setCellValue('I1', 'CIN');
        $sheet->setCellValue('J1', 'VILLE');
        $sheet->setCellValue('K1', 'TEL CANDIDAT');
        $sheet->setCellValue('L1', 'MAIL CANDIDAT');
        $sheet->setCellValue('M1', 'ETABLISSEMENT');
        $sheet->setCellValue('N1', 'FORMATION');
        $sheet->setCellValue('O1', "NIVEAU D'ETUDES");
        $sheet->setCellValue('P1', 'CATEGORIE');
        $sheet->setCellValue('Q1', 'TYPE DE BAC');
        $sheet->setCellValue('R1', 'ANNEE BAC');
        $sheet->setCellValue('S1', 'MOYENNE GENERALE');
        $sheet->setCellValue('T1', 'MOYENNE NATIONALE');
        $sheet->setCellValue('U1', 'MOYENNE REGIONALE');
        $sheet->setCellValue('V1', 'D-INSCRIPTION');
        ...
        foreach ($inscriptions as $inscription) {
            ...
            $sheet->setCellValue('E'.$i, $inscription->getCode());
            ...
            $sheet->setCellValue('H'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getDateNaissance());
            $sheet->setCellValue('I'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getCin());
            $sheet->setCellValue('J'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getVille());
            $sheet->setCellValue('K'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getTel1());
            $sheet->setCellValue('L'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getMail1());
            $sheet->setCellValue('M'.$i, $inscription->getAnnee()->getFormation()->getEtablissement()->getDesignation());
            $sheet->setCellValue('N'.$i, $inscription->getAnnee()->getFormation()->getDesignation());
            $sheet->setCellValue('O'.$i, $inscription->getPromotion()->getDesignation());
            $sheet->setCellValue('P'.$i, 'CATEGORIE');
            $sheet->setCellValue('Q'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getTypeBac() == Null ? "" : $inscription->getAdmission()->getPreinscription()->getEtudiant()->getTypeBac()->getDesignation());
            $sheet->setCellValue('R'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getAnneeBac());
            $sheet->setCellValue('S'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getMoyenneBac());
            $sheet->setCellValue('T'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getMoyenNational());
            $sheet->setCellValue('U'.$i, $inscription->getAdmission()->getPreinscription()->getEtudiant()->getMoyenRegional());
            $sheet->setCellValue('V'.$i, $inscription->getCreated());
