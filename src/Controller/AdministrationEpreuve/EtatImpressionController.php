...
#[Route('/administration/etat_impression')]
class EtatImpressionController extends AbstractController
{
    ...
    #[Route('/', name: 'etat_impression')]
    public function index(Request $request): Response
    {
        $operations = ApiController::check($this->getUser(), 'etat_impression', $this->em,$request);
        ...
        return $this->render('administration_epreuve/etat_impression.html.twig', [
    ...
    #[Route('/etat_controle/{semestre}', name: 'etat_controle')]
