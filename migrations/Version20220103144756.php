 ...
 */
final class Version20220103144756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tpreinscription (id INT AUTO_INCREMENT NOT NULL, statut_id INT DEFAULT NULL, etudiant_id INT NOT NULL, statut_deliberation_id INT DEFAULT NULL, annee_id INT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, inscription_valide SMALLINT DEFAULT NULL, rang_p INT DEFAULT NULL, rang_s INT NOT NULL, categorie_liste VARCHAR(100) DEFAULT NULL, admission_liste VARCHAR(255) DEFAULT NULL, tele_liste VARCHAR(100) DEFAULT NULL, active SMALLINT DEFAULT NULL, mentionner_admissible SMALLINT DEFAULT NULL, created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, INDEX IDX_EED29A80F6203804 (statut_id), INDEX IDX_EED29A80DDEAB1A3 (etudiant_id), INDEX IDX_EED29A8095B0C43E (statut_deliberation_id), INDEX IDX_EED29A80543EC5F0 (annee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
